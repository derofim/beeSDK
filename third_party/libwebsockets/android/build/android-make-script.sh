...
export OPENSSL_DIR=/home/hezhen/mediasdk/third_party/openssl/android
...
#[ -d openssl-1.0.2j ] && rm -fr openssl-1.0.2j
...
# setup buildflags
export ARCH_FLAGS="-mthumb -march=armv7-a -mfpu=vfpv3-d16"
