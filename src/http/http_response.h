...
public:
    ...
    const std::map<std::string, std::string, lower_comp>& get_header_table() const {return m_header_fields_map;}

private:
	std::string m_protocol_and_version;
    unsigned int m_status_code;
    std::string m_reason_str;
	std::map<std::string, std::string, lower_comp> m_header_fields_map;
