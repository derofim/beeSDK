...
protected:
	...
	comLib::SafeQueue<int> m_start_lock_queue;
	comLib::SafeQueue<int> m_stop_lock_queue;
	comLib::Mutex m_mutex;
};
...
inline bool Thread::Start(void* lpParam)
{
	...
	m_ThreadId = (int)(size_t)ThreadID;
	return true;
}
