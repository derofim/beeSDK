...
public class HudFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    controlView = inflater.inflate(R.layout.drawer_header, container, false);
  ...
  public void setViews(TextView v1, TextView v2, TextView v3, TextView v4, TextView v5) {
    encoderStatView = v1;
    hudViewBwe = v2;
    hudViewConnection = v3;
    hudViewVideoSend = v4;
    hudViewVideoRecv = v5;
  }

  public void clearViews() {
    encoderStatView = null;
    hudViewBwe = null;
    hudViewConnection = null;
    hudViewVideoSend = null;
    hudViewVideoRecv = null;
  }
  ...
  public void onStart() {
    ...
    if (args != null) {
      ...
      displayHud = args.getBoolean(AudioChatRoomActivity.EXTRA_DISPLAY_HUD, false);
    }
  ...
  public void updateEncoderStatistics(final StatsReport[] reports) {
    encoderStat = new StringBuilder(128);
    bweStat = new StringBuilder();
    connectionStat = new StringBuilder();
    videoSendStat = new StringBuilder();
    videoRecvStat = new StringBuilder();
