package com.sohu.tv.edu.base.ui.popmenu;
...
public class DropPopMenu {
    ...
    private void init() {
        ...
        mIconTextMargin = (int) mContext.getResources().getDimension(R.dimen.drop_pop_menu_icon_text_margin);
        mHorizontalMargin = (int) mContext.getResources().getDimension(R.dimen.drop_pop_menu_item_horizontal_margin);
        mIconWidth = (int) mContext.getResources().getDimension(R.dimen.drop_pop_menu_icon_width);
        mItemHeight = (int) mContext.getResources().getDimension(R.dimen.drop_pop_menu_item_height);
        mTextSize = (int) mContext.getResources().getDimension(R.dimen.drop_pop_menu_text_size);
