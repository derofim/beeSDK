...
public class SurfaceTextureHelper {
  ...
  public static SurfaceTextureHelper create(
    ...
    Logging.e(TAG, "SurfaceTextureHelper create");

    // The onFrameAvailable() callback will be executed on the SurfaceTexture ctor thread. See:
    // http://grepcode.com/file/repository.grepcode.com/java/ext/com.google.android/android/5.1.1_r1/android/graphics/SurfaceTexture.java#195.
    // Therefore, in order to control the callback thread on API lvl < 21, the SurfaceTextureHelper
    // is constructed on the |handler| thread.
      SurfaceTextureHelper sth = ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() {
      @Override
      public SurfaceTextureHelper call() {
        try {
            SurfaceTextureHelper surfaceTextureHelper = new SurfaceTextureHelper(sharedContext, handler);
            Logging.e(TAG, "SurfaceTextureHelper new hash = " + surfaceTextureHelper.hashCode());
  ...
  private SurfaceTextureHelper(EglBase.Context sharedContext, Handler handler) {
    ...
    Logging.d(TAG, "Java SurfaceTextureHelper created");
  }
  ...
  public void returnTextureFrame() {
    //Logging.d(TAG, "Java returnTextureFrame");
  ...
  public void dispose() {
    ...
    Logging.d(TAG, "SurfaceTextureHelper dispose(), ref = " + ref + " hash = " + this.hashCode());
    if (ref == 0) {
      ThreadUtils.invokeAtFrontUninterruptibly(handler, new Runnable() {
        @Override
        public void run() {
