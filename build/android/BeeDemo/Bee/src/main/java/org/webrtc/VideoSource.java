...
public class VideoSource extends MediaSource {
  ...
  public static void initializeVideoCapturer(
    Context appContext,
    VideoCapturer j_video_capturer,
    long native_source,
    VideoCapturer.CapturerObserver j_frame_observer) {
    nativeInitializeVideoCapturer(appContext, j_video_capturer, native_source, j_frame_observer);
  }
  ...
  private static native void nativeInitializeVideoCapturer(
      Context appContext, VideoCapturer j_video_capturer, long native_source,
      VideoCapturer.CapturerObserver j_frame_observer);
}
