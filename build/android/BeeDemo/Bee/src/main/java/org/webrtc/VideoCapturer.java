...
public interface VideoCapturer {
  ...
  static class AndroidVideoTrackSourceObserver implements CapturerObserver {
    ...
    public AndroidVideoTrackSourceObserver(long nativeSource, ExternalObserver observer) {
      this.nativeSource = nativeSource;
    ...
    public void onCapturerStarted(boolean success) {
      if (externalObserver != null) {
        externalObserver.onCapturerStarted(success);
      }
    ...
    public void onCapturerStopped() {
      if (externalObserver != null) {
        externalObserver.onCapturerStopped();
      }
